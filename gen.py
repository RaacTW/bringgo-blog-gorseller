...
"mexican-parcel-carriers-comparison": ("Mexican parcel carriers compared","Coverage and best fit · 2026","carrier",[("Estafeta","40+ years, ~95% territory","National ground"),("Paquetexpress","30+ years, 180+ points","E-commerce ground"),("FedEx","89 stations, 3,000+ vehicles","Speed, hard addresses"),("DHL Express","International, real-time tracking","Fast express"),("99 Minutos","52 cities, same-day","City core")]),
"paqueterias-mexico-comparativa": ("Paqueterías en México comparadas","Cobertura y uso ideal · 2026","carrier",[("Estafeta","40+ años, ~95% territorio","Terrestre nacional"),("Paquetexpress","30+ años, 180+ puntos","E-commerce terrestre"),("FedEx","89 estaciones, 3.000+ vehículos","Velocidad"),("DHL Express","Internacional, rastreo","Exprés rápida"),("99 Minutos","52 ciudades, mismo día","Núcleo urbano")]),
"ship-pallet-texas-mexico-cost": ("Cost to ship a pallet to Mexico","Cost lines · 2026","cost",[("LTL freight (1 pallet)","~$350-800","n"),("FTL freight","Near/below $2 per mile","mut"),("Customs broker","A few thousand MXN","n"),("Duty · US origin (USMCA)","0% · USMCA","hi"),("IVA (VAT)","16% (8% border)","n"),("Border transfer","Varies · quote","mut")]),
"mercado-libre-nedir-rehber": ("Mercado Libre satıcı maliyeti","Katmanlar · 2026","cost",[("Satış komisyonu","Kategoriye göre","n"),("Mercado Envíos Full","Depolama + gönderi","mut"),("İthalat IVA","%16 (%8 sınır)","n"),("Gümrük · ABD menşe","%0 · USMCA","hi"),("Reklam (Mercado Ads)","İsteğe bağlı","mut")]),
